...
class SparseMatrixCSCTest {
    ...
    void createRepresentation() throws FileNotFoundException, OperationNotSupportedException {
        ...
        assertEquals(values.length, instance.getValues().length);
        assertEquals(rows.length, instance.getRows().length);
        assertEquals(cols.length, instance.getColumns().length);
